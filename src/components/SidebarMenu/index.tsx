    ...
    <>
      ...
      >
        <div className='w-full border-b border-white/20 uppercase text-white/60 pb-[0.4vw] mb-[2.2vw] '>
          <h3 className='text-[0.9vw] md:text-[2vw] leading-[1.1]'>Навигация</h3>
        </div>
        <div className='flex flex-col h-full justify-between'>
          ...
          <Link
            ...
            className='flex items-center justify-center bg-zinc-600 active:bg-zinc-700 transition hover:bg-zinc-700/60 px-1.5 py-1.5 rounded-sm gap-2 w-[114%] -translate-x-[7%]'
          >
            <svg
            ...
            <p className='text-[1.2vw] font-medium tracking-wide'>Поставить звездочку</p>
          </Link>
        </div>
