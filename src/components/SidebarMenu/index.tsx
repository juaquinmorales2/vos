      ...
      >
        ...
        <div className='flex flex-col h-full justify-between'>
          ...
          <Link
            ...
            className='flex items-center justify-center bg-zinc-600 active:bg-zinc-700 transition hover:bg-zinc-700/60 px-1.5 py-1.5 rounded-sm gap-2 w-full'
          >
            <svg
            ...
            <p className='text-[1.2vw] font-medium tracking-wide'>Give a star</p>
          </Link>
        </div>
