...
const Index: FC<Props> = () => {
  return (
    <section id="about" className="border-t border-gray-1 bg-gradient-to-b py-[6vw] z-0">
      <SectionOpacity classes='z-2'>
        <SectionTitle title="О НАС." classes="px-[6vw] pt-[3vw] z-10" />
        <div className="relative self-start px-[6vw] pb-[5vw] pt-[3vw]">
          <div className="flex space-x-[5vw]">
            ...
            <div className="relative h-[20vw] w-[30vw] grow-[3] basis-0 bg-bg-2">
              <img src="/images/hands_v2.jpg" alt="image" className="rounded-sm hover:brightness-110 transition absolute inset-0 w-full h-full" />;
            </div>
          </div>
        </div>
      </SectionOpacity>
